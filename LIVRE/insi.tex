...
On observe que la distribution de la densité de tilapia n'est pas normale : une forte concentration d'observations se situe dans la tranche des faibles densités (10 à 13 tilapias par are), avec une seconde concentration notable dans la tranche des densités élevées (45 à 50). Cette répartition suggère l'existence de deux régimes de production distincts dans le jeu de données, plutôt qu'une évolution progressive et homogène de la densité.
