...
AUC-ROC & Aire sous la courbe ROC, mesurant la capacité d'un modèle de classification à distinguer les deux classes indépendamment d'un seuil de décision fixe \cite{scikitlearn}. \\[24pt]
